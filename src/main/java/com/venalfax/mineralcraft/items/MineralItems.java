...
import com.venalfax.mineralcraft.foods.MineralFoods;
import com.venalfax.mineralcraft.items.custom.GemDetectorItem;
	...
	public static final DeferredItem<Item> GARNET = ITEMS.registerItem("garnet", 
			properties -> new Item(properties.fireResistant()) {
				...
				public void appendHoverText(ItemStack itemStack, TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag tooltipFlag) {
					builder.accept(Component.translatable("tooltip.mineralcraft.garnet.tooltip"));
