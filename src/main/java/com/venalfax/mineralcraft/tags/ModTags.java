package com.venalfax.mineralcraft.tags;
...
public class ModTags {
	...
	public static class Blocks{
		...
		private static TagKey<Block> createTag(String name) {
			return BlockTags.create(Identifier.fromNamespaceAndPath(MineralCraft.MOD_ID, name));
		}
	}
	...
	public static class Items{
		...
		private static TagKey<Item> createTag(String name) {
			return ItemTags.create(Identifier.fromNamespaceAndPath(MineralCraft.MOD_ID, name));
		}
	}
