...
public class MineralArmorMaterials {
	...
	public static final ResourceKey<EquipmentAsset> SAPPHIRE_KEY = ResourceKey.create(ROOT_ID, Identifier.fromNamespaceAndPath(MysticMinerals.MOD_ID, "sapphire"));
	public static final ResourceKey<EquipmentAsset> EMERALD_KEY = ResourceKey.create(ROOT_ID, Identifier.fromNamespaceAndPath(MysticMinerals.MOD_ID, "emerald"));
	public static final ResourceKey<EquipmentAsset> FLINT_KEY = ResourceKey.create(ROOT_ID, Identifier.fromNamespaceAndPath(MysticMinerals.MOD_ID, "flint"));
	public static final ResourceKey<EquipmentAsset> TEMPERED_FLINT_KEY = ResourceKey.create(ROOT_ID, Identifier.fromNamespaceAndPath(MysticMinerals.MOD_ID, "tempered_flint"));
