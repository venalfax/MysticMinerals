...
public class ModTags {
	...
	public static class Items{
		...
		public static final TagKey<Item> GARNET_BLOCK_CONVERTABLE = createTag("garnet_block_convertable");
		public static final TagKey<Item> BUDDING_AMETHYST_CONVERTABLE = createTag("budding_amethyst_convertable");
		public static final TagKey<Item> BUDDING_GARNET_CONVERTABLE = createTag("budding_garnet_convertable");
